        ...
        <View style={this.state.light_theme ? styles.containerLight : styles.container}>
          ...
          <View style={styles.appTitle}>
            ...
            <View style={styles.appTitleTextContainer}>
              <Text style={this.state.theme_light ? styles.appTitleTextLight : styles.appTitleText}>App Narração de Histórias</Text>
            </View>
          </View>
            ...
            <ScrollView style={this.state.light_theme ? styles.storyCardLight : styles.storyCard}>
              ...
              <View style={styles.dataContainer}>
                <View style={styles.titleTextContainer}>
                  <Text style={this.state.theme_light ? styles.storyTitleTextLight :styles.storyTitleText}>
              ...
              <View style={styles.storyTextContainer}>
                <Text style={this.state.theme_light ? styles.storyTextLight : styles.storyText}>
                  {this.props.route.params.story.story}
                </Text>
                <Text style={this.state.theme_light ? styles.moralTextLight : styles.moralText}>
